...
class CoinCheck:
    ...
    def urlencode(self, arr):
        if six.PY2:
            return urllib.urlencode(arr)
        else:
            return urllib.parse.urlencode(arr)
    ...
    def setSignature(self, path, method, arr):
        ...
        if method == ServiceBase.METHOD_GET:
            message = nonce + url + self.urlencode(arr)
    ...
    def request(self, method, path, params):
        ...
        self.client = http.client.HTTPSConnection(self.apiBase, timeout=60)
